      ...
      <div className="p-6">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <button
            ...
            className="px-3 py-1 text-xs font-medium rounded-md bg-secondary hover:bg-accent transition-colors text-foreground"
          >
            Hoje
          </button>
          <button onClick={() => setCurrentDate(new Date(year, month + 1, 1))} className="w-8 h-8 rounded-lg flex items-center justify-center hover:bg-secondary transition-colors">
                        ...
                        <div className="space-y-1">
                          {dayContents.slice(0, 3).map(c => (
                            <button
                              ...
                              className={cn(
                                "w-full text-left px-1.5 py-1 rounded text-[11px] font-medium truncate flex items-center gap-1 hover:opacity-80 transition-opacity",
                                STATUS_COLORS[c.status], "text-primary-foreground"
                              )}
                            >
